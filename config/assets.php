...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | HTTP Cache of any glide generate assets
    |--------------------------------------------------------------------------
    |
    | Assets generated by Glide are sent to the browser with a default cache
    | expiry time. Be setting it, you can control how long the browser will
    | store assets locally until it asks for a fresh version.
    |
    */

    'glide_http_expiry_after_seconds' => 31536000,

    /*
    |--------------------------------------------------------------------------
    | Upload handling in CP
    |--------------------------------------------------------------------------
    |
    | Controls how file uploads are handled in Control Panel: Either the
    | uploaded file will replace an existing file (clearing its Glide
    | cache) or a timestamp will be appended to prevent overwriting.
    |
    */
